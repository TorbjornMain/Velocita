...
////// Emissive:
                ...
                float3 emissive = ((_Color.rgb*_Color.a)*node_1514);
                float3 finalColor = emissive;
                return fixed4(finalColor,node_1514);
            }
            ENDCG
        }
    }
