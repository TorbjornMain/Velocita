        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_1836 = tex2Dlod(_WaveTexture,float4(TRANSFORM_TEX(v.texcoord0, _WaveTexture),0.0,0));
                    ...
                    v.vertex.xyz += (((saturate(node_9819.b)*2.0)-1.0)*v.normal*_DisplacementScale);
                }
