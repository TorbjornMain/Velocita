...
////// Emissive:
                ...
                float3 emissive = (_PatternTexture_var.rgb*_Color.rgb*(((sin(((node_4500.a*_Speed)+lerp(((node_5651-node_4388)*_WaveFrequency),(node_4388*_WaveFrequency),((sin((i.uv0.g*3.0))+node_5651)*0.5))))+1.0)/node_3950)+_BaseAlpha)*_PatternTexture_var.a*_Color.a);
